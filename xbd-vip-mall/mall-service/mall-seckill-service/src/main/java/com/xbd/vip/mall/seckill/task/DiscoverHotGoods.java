package com.xbd.vip.mall.seckill.task;
...
import com.xbd.vip.mall.dw.feign.HotGoodsFeign;
...
public class DiscoverHotGoods implements SimpleJob {
    ...
    public void execute(ShardingContext shardingContext) {
        ...
        for (Map<String, String> dataMap : data) {
            // /msitemslog/123.html
//            System.out.println(uriReplace(1,dataMap.get("uri")));
            seckillGoodsService.isolation(uriReplace(1,dataMap.get("uri")));
        }
    }

    /***
     * 查询redis已存在的所有热门商品ID集合
     */
